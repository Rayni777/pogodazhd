...
func receivedMessageHandler(chatId string, userStatus string, receivedMessage string) {
	...
	if receivedMessage == "🆘 помощь" {
		msg.Text = "ошибки, отзывы и вопросы - @Rayni777"
	}
	if receivedMessage == "Свердловская обл." {
		msg.Text =
			"В свердловская обл. часто встречаются: " +
				...
				" " +
				"\n " +
				"Интересные природные места:" +
				"\n " +
				"Заповедник «Денежкин Камень»" +
				"\n " +
				"http://www.denkamen.ru/" +
				"\n " +
				" " +
				"\n " +
				"Озеро Таватуй" +
				"\n " +
				"https://ru.wikipedia.org/wiki/%D0%A2%D0%B0%D0%B2%D0%B0%D1%82%D1%83%D0%B9" +
				"\n " +
				" " +
				"\n " +
				"Перевал Дятлова" +
				"\n " +
				"https://ru.wikipedia.org/wiki/%D0%9F%D0%B5%D1%80%D0%B5%D0%B2%D0%B0%D0%BB_%D0%94%D1%8F%D1%82%D0%BB%D0%BE%D0%B2%D0%B0"
	}
	...
	case "start":
		...
		text, buttons := getDistricts()
		msg.Text, msg.ReplyMarkup = "Бот создан для оповещений о 🌳 климатических и 🌦️ погодных  условиях\nВыберите округ\n"+text, buttons
